            ...
            <div class="container w-75 px-4 pt-4 pb-3 border border-primary">
                ...
                <table class="table table-light table-striped-columns border border-primary">
                    ...
                    <tr>
                        ...
                        <td class="text-muted"></td>
                        <td class="text-muted"></td>
                        <td class="text-muted text-center"><a href="editarAbono.php"><img src="../../../Views/Assets/img/editar.png" width="25px" alt="editar"></a></td>
                        <td class="text-muted text-center"><a href="eliminarAbono.php"><img src="../../../Views/Assets/img/eliminar.png" width="25px" alt="eliminar"></a></td>
                    </tr>
                </table>
